...
function TopNavi() {
  ...
  const isAdmin = login?.roles?.some(
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="mynavbar">
          <ul className="navbar-nav me-auto">
            ...
            {isLoggedIn && (
              <li className="nav-item">
                <NavLink to="/pacs/list" className="nav-link">
                  PACS
                </NavLink>
              </li>
            )}
            ...
            {isAdmin && (
              <>
                <li className="nav-item">
                  <NavLink to="/admin/medical-staff" className="nav-link">
                    의료진 관리
                  </NavLink>
                </li>

                <li className="nav-item">
                  <NavLink to="/admin/access-logs" className="nav-link">
                    접근 이력
                  </NavLink>
                </li>
              </>
