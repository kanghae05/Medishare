      ...
      <style>
        {`
          ...
          .loading-ring {
            ...
            border-radius: 50%;
            animation: pacsSpin .7s linear infinite;
          }
          ...
          .pacs-modal-card {
            ...
            border-radius: 16px;
            background: #ffffff;
            box-shadow: 0 24px 70px rgba(13,28,48,.24);
          }
